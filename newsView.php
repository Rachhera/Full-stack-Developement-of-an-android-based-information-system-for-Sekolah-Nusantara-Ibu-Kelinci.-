...
<script>
    ...
    let app = Vue.createApp({
        ...
        methods: {
            ...
            generateTable() {
                $("#table").dataTableLib({
                    url: window.location.origin + '/service/content/data/news',
                    selectID: 'content_id',
                    colModel: [{
                            display: 'Gambar',
                            name: '',
                    ...
                    search: true,
                    searchTitle: 'Pencarian Data Berita',
                    searchItems: [{
                            display: 'Judul',
                            name: 'content_title',
                            type: 'text'
            ...
            add() {
                this.modal.data.title = "Tambah Data Berita";
            ...
            view(url) {
                this.image.title = "Gambar Berita";
                this.image.src = url

                $('#modalShowImage').modal()
            },
            update(content_id) {
                this.modal.data.title = "Update Data Berita";
